package com.vitefinetechapp.vitefinetech.LandLine;
...
public class LandlineBillActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(LandlineBillActivity.this);
        ...
        arrayAdapter=new ArrayAdapter( LandlineBillActivity.this, android.R.layout.simple_list_item_1,operatorList);
        ...
        btn_fetchInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(account_id.getText())){
                    Toast.makeText(LandlineBillActivity.this, "Enter a valid Account id", Toast.LENGTH_SHORT).show();
                }
                else if(spinner.getSelectedItem()==null || selected_operator.equals("-select service provider")){
                    Toast.makeText(LandlineBillActivity.this, "Select a Service provider", Toast.LENGTH_SHORT).show();
                }
                else{
                    progressDialog.show();
                    setcInfo();
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (spinner.getSelectedItem() == null)
                    Toast.makeText(LandlineBillActivity.this, "Select service provider", Toast.LENGTH_SHORT).show();
                else if (TextUtils.isEmpty(account_id.getText().toString()))
                    Toast.makeText(LandlineBillActivity.this, "Enter a valid Account number", Toast.LENGTH_SHORT).show();
                else {
                    String type = "landline";
                    String service="16";
                    Log.d(TAG+"2", amtBal + "");
                    Intent i = new Intent(LandlineBillActivity.this, Electricity_makePaymentActivity.class);
                    ...
                    try {
                        ...
                        if (jsonArray != null) {
                            for (int i = 0; i < jsonArray.length(); i++) {
                                if (jsonArray.getJSONObject(i).getString("category").equals("Landline") ) {
                        ...
                        final ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(LandlineBillActivity.this, android.R.layout.simple_spinner_dropdown_item, operatorList);
