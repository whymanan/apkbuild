...
public class MunicipalityHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_municipality_history, container, false);
...
//                    Log.d("ElecMakeRechargeError", "error:" + error.getMessage());
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("service_id", 46+"");
                params.put("api_requist", "municipal");
