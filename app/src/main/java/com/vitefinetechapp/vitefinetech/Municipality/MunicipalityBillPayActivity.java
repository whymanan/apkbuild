package com.vitefinetechapp.vitefinetech.Municipality;
...
public class MunicipalityBillPayActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_municipality_bill_pay);
        ...
        progressDialog = new ProgressDialog(MunicipalityBillPayActivity.this);
        ...
        arrayAdapter=new ArrayAdapter( MunicipalityBillPayActivity.this, android.R.layout.simple_list_item_1,operatorList);
        ...
        btn_fetchInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(account_id.getText())){
                    Toast.makeText(MunicipalityBillPayActivity.this, "Enter a valid Account id", Toast.LENGTH_SHORT).show();
                }
                else if(spinner.getSelectedItem()==null || selected_operator.equals("-select service provider")){
                    Toast.makeText(MunicipalityBillPayActivity.this, "Select a Service provider", Toast.LENGTH_SHORT).show();
                }
                else{
                    progressDialog.show();
                    setcInfo();
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (spinner.getSelectedItem() == null)
                    Toast.makeText(MunicipalityBillPayActivity.this, "Select service provider", Toast.LENGTH_SHORT).show();
                else if (TextUtils.isEmpty(account_id.getText().toString()))
                    Toast.makeText(MunicipalityBillPayActivity.this, "Enter a valid Account number", Toast.LENGTH_SHORT).show();
                else {
                    String type = "municipal";
                    String service="46";
                    Log.d(TAG+"2", amtBal + "");
                    Intent i = new Intent(MunicipalityBillPayActivity.this, Electricity_makePaymentActivity.class);
    ...
    private void fetchOperator() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    try {
                        ...
                        if (jsonArray != null) {
                            for (int i = 0; i < jsonArray.length(); i++) {
                                if (jsonArray.getJSONObject(i).getString("category").equals("Municipality") ) {
                        ...
                        final ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(MunicipalityBillPayActivity.this, android.R.layout.simple_spinner_dropdown_item, operatorList);
                ...
                error -> {
                    Log.d(TAG+"setOperatorError", error.getMessage());
                }
        );
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        requestQueue.add(stringRequest);
