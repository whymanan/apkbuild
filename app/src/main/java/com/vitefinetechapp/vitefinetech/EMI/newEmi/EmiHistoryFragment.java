...
public class EmiHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_emi_history, container, false);
...
//                    Log.d("ElecMakeRechargeError", "error:" + error.getMessage());
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("service_id", 41+"");
                params.put("api_requist", "EMI");
